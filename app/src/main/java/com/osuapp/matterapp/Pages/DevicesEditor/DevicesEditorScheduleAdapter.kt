...
class DevicesEditorScheduleAdapter(var schedules : List<DevicesEditorViewModel.ScheduleListItem>)
    : RecyclerView.Adapter<DevicesEditorScheduleAdapter.ViewHolder>() {
